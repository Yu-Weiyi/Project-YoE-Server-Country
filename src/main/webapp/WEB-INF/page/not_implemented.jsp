        ...
        <div class="layui-body" style="color: #dddddd; left: 0px;">
            <div class="layui-container" align="center">
                ...
                <div class="layui-row" style="width: 50%">
                    <h2 class="layui-bg-blue">未实装页面</h2>
                </div>
                <div class="layui-row" style="height: 20px"></div>
                <div class="layui-row layui-font-20 layui-font-red">
                    点击了还未实装的功能，进入了这个奇怪的页面，来到了寸草不生的荒原。
                </div>
                <div class="layui-row" style="height: 20px"></div>
                <div class="layui-row" align="center">
                    <img src="/static/image/not_implemented_1.jpg" width="30%" height=auto />
                </div>
                <div class="layui-row" style="height: 20px"></div>
                <div class="layui-row" align="center">
                    <img src="/static/image/not_implemented_2.jpg" width="30%" height=auto />
                </div>
                <div class="layui-row" style="height: 20px"></div>
                <blockquote class="layui-elem-quote layui-font-20 layui-font-black">巅峰迎来虚伪的拥护 黄昏见证真正的信徒</blockquote>
                <hr class="layui-border-green">
                <div class="layui-row" style="height: 20px"></div>
            </div>
