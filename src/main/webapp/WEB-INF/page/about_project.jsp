    ...
    <body>
        ...
        <div class="layui-body" style="color: #dddddd; left: 0px;">
            <div class="layui-container layui-font-black" align="center">
                ...
                <div class="layui-row" style="height: 20px"></div>
                <blockquote class="layui-elem-quote" align="left">
                    <p>《邮易 YoE》是由于魏祎开发的一款物流系统项目，于2023年1月底立项。</p>
                    <p>数据存储在一个被称作“HugeGraph”的图数据库，在这里，被系统记录的数据将被存入“数据库”，导引计算之力。用户将扮演一位名为“使用者”的神秘角色，在自由的浏览中邂逅性格各异、能力独特的网页们，和它们一起新建订单，查询邮寄的包裹——同时，逐步发掘“邮易 YoE”的真相。</p>
                </blockquote>
                <div class="layui-row" style="height: 20px"></div>
                <hr class="layui-border-green">
                <div class="layui-row" style="height: 20px"></div>
