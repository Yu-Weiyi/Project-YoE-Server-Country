...
<html>
    <head>
        ...
        <title>邮易 YoE 仓储物流 国际大宗水运</title>
        ...
        <div class="layui-body font-SmileySans" style="color: #dddddd; left: 0px;">
            <div class="layui-container" align="center">
                ...
                <div class="layui-row" style="width: 50%">
                    <h2 class="layui-bg-blue">国际大宗水运</h2>
                </div>
                    ...
                    <div class="layui-col-md12">
                        <fieldset class="layui-elem-field layui-bg-gray layui-font-black" align="left" style="width: 80%">
                            ...
                            <div class="layui-field-box">
                                邮易YoE在整合优势航运资源的基础上，大力推进国际大宗水运物流业务。<br>
                                拥有专业从事国际船舶代理服务及无船承运人业务的船舶代理公司，代理服务已经覆盖国内上海、青岛、大连、天津、厦门、太仓等多个口岸，拥有丰富的集装箱船、干散货船、油轮及其他特种船舶代理服务经验。<br>
                                经营海运、空运进出口货物的国际运输代理业务，包括揽货、订舱、仓储、中转、集装箱拼装拆箱、结算运杂费、报关、报验、保险、相关的短途运输服务及咨询业务。<br>
                                同时，邮易YoE与世界知名仓储物流企业合作，大力推进外高桥综合物流基地和国际集装箱中转中心建设，致力于建成集第三方物流、中高端物流服务、国际贸易配套服务、多式联运等功能为一体的邮易YoE外高桥综合物流基地。<br>
