...
import pers.yuweiyi.YoE_logistics.dao.edge.ProvinceToDAO;
import pers.yuweiyi.YoE_logistics.util.GraphDatabaseUtil;

/**
 * projectName: YoE-logistics-Server-Country <br/>
 * className: ProvinceToDAOImpl <br/>
 * description: 数据库中对ProvinceTo边操作实现。 <br/>
 *
 * @author yu_weiyi 于魏祎 <a href="mailto:yu_weiyi@outlook.com" >yu_weiyi@outlook.com</a> <br/>
 * @version 1.0 <br/>
 * @since 2/6/2023 10:11 PM <br/>
 */
@Repository
public class ProvinceToDAOImpl implements ProvinceToDAO {
    GremlinManager gremlin = GraphDatabaseUtil.gremlinManager;

    @Override
    public Edge insert(@NotNull Vertex order, @NotNull Vertex province) {
        Edge edge = order.addEdge("provinceTo", province);
        return edge;
    }
